...
`Sample Code` [`원문`](https://developer.apple.com/documentation/uikit/uifont/creating_self-sizing_table_view_cells)

Create table view cells that support Dynamic Type and use system spacing constraints to adjust the spacing surrounding text labels.

> 다이나믹 타입을 지원하는 테이블 뷰를 만들고 system spacing constraint를 사용하여 텍스트 레이블 주변의 spacing을 조정합니다.

[`Sample Code Project`](https://github.com/KyungminLeeDev/learning-with-apple-official-resources/tree/main/documentation/uikit/uifont/CreatingSelfSizingTableViewCells)
